...
class ManufacturerAttributeReader extends ApiReader
{
    public function supports(MigrationContextInterface $migrationContext): bool
    {
        return $migrationContext->getProfile() instanceof OxidProfileInterface
            ...
            && $migrationContext->getDataSet()::getEntity() === DefaultEntities::PRODUCT_MANUFACTURER_CUSTOM_FIELD;
    }

    protected function getApiRoute(): string
    {
        return 'SwagMigrationManufacturerAttributes';
    }
}
