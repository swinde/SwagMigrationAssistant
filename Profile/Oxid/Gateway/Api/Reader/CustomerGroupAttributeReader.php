...
class CustomerGroupAttributeReader extends ApiReader
{
    public function supports(MigrationContextInterface $migrationContext): bool
    {
        return $migrationContext->getProfile() instanceof OxidProfileInterface
            ...
            && $migrationContext->getDataSet()::getEntity() === DefaultEntities::CUSTOMER_GROUP_CUSTOM_FIELD;
    }

    protected function getApiRoute(): string
    {
        return 'SwagMigrationCustomerGroupAttributes';
    }
}
