...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49CustomerGroupConverter;
...
class CustomerGroupConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49CustomerGroupConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid49CustomerGroupConverter($mappingService, new DummyLoggingService());
