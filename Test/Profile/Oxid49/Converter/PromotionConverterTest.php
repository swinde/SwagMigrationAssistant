...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49PromotionConverter;
...
class PromotionConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid49PromotionConverter($this->mappingService, $this->loggingService, $salesChannelRepo);
