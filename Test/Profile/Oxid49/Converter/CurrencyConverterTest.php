...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49CurrencyConverter;
...
class CurrencyConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid49CurrencyConverter($this->mappingService, $this->loggingService);
    ...
    {
        $this->converter = new Oxid49CurrencyConverter(new DummyMappingService(), $this->loggingService);
        $currencyData = require __DIR__ . '/../../../_fixtures/currency_data.php';
        $convertResult = $this->converter->convert($currencyData[0], $this->context, $this->migrationContext);
