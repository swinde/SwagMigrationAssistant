...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49ProductAttributeConverter;
...
class ProductAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49ProductAttributeConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid49ProductAttributeConverter($mappingService, $this->loggingService);
