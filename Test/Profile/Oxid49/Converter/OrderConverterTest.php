...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49CustomerConverter;
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49OrderConverter;
...
class OrderConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49OrderConverter
     */
    private $orderConverter;

    /**
     * @var Oxid49CustomerConverter
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->orderConverter = new Oxid49OrderConverter($mappingService, $this->loggingService, $taxCalculator);
        $this->customerConverter = new Oxid49CustomerConverter($mappingService, $this->loggingService, Validation::createValidator());
