...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49CustomerGroupAttributeConverter;
...
class CustomerGroupAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49CustomerGroupAttributeConverter
     */
    private $converter;

    protected function setUp(): void
    {
        $this->converter = new Oxid49CustomerGroupAttributeConverter(new DummyMappingService(), new DummyLoggingService());
