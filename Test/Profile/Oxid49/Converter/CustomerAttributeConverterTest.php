...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49CustomerAttributeConverter;
...
class CustomerAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49CustomerAttributeConverter
     */
    private $converter;

    protected function setUp(): void
    {
        $this->converter = new Oxid49CustomerAttributeConverter(new DummyMappingService(), new DummyLoggingService());
    ...
    public function testConvertTextAttribute(): void
    {
        ...
        static::assertSame('migration_ConnectionName_customer_attr6', $converted['customFields'][0]['name']);
