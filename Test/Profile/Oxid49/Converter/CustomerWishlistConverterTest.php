...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49CustomerWishlistConverter;
...
class CustomerWishlistConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49CustomerWishlistConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid49CustomerWishlistConverter($this->mappingService, new DummyLoggingService());
