...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49ProductOptionRelationConverter;
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49ProductPropertyRelationConverter;
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49PropertyGroupOptionConverter;
...
class PropertyGroupOptionConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49PropertyGroupOptionConverter
     */
    ...
    /**
     * @var Oxid49ProductConverter
     */
    private $productConverter;

    /**
     * @var Oxid49ProductOptionRelationConverter
     */
    private $optionRelationConverter;

    /**
     * @var Oxid49ProductPropertyRelationConverter
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->propertyGroupOptionConverter = new Oxid49PropertyGroupOptionConverter(
            $this->mappingService,
            $this->loggingService,
            $mediaFileService
        );

        $this->productConverter = new Oxid49ProductConverter(
            $this->mappingService,
            $this->loggingService,
            $mediaFileService
        );

        $this->optionRelationConverter = new Oxid49ProductOptionRelationConverter(
            $this->mappingService,
            $this->loggingService
        );

        $this->propertyRelationConverter = new Oxid49ProductPropertyRelationConverter(
            $this->mappingService,
            $this->loggingService
        );
