...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49MainVariantRelationConverter;
...
class MainVariantRelationConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49MainVariantRelationConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid49MainVariantRelationConverter($this->mappingService, $this->loggingService);
