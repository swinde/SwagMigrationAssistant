...
use SwagMigrationAssistant\Profile\Oxid49\Mapping\Oxid49MappingServiceInterface;
...
abstract class OxidConverterTest extends TestCase
{
    ...
    abstract protected function createConverter(Oxid49MappingServiceInterface $mappingService, LoggingServiceInterface $loggingService, MediaFileServiceInterface $mediaFileService): ConverterInterface;

    abstract protected function createProfile(): Oxid49MappingServiceInterface;
