...
use SwagMigrationAssistant\Profile\Oxid\Converter\OrderDocumentConverter;
...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49OrderDocumentConverter;
...
class OrderDocumentConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->orderDocumentConverter = new Oxid49OrderDocumentConverter($mappingService, $this->loggingService, $mediaFileService);
        $connectionId = Uuid::randomHex();
        $this->runId = Uuid::randomHex();
        $this->connection = new SwagMigrationConnectionEntity();
        $this->connection->setId($connectionId);
        $this->connection->setProfileName(Oxid49Profile::PROFILE_NAME);
        $this->connection->setGatewayName(OxidLocalGateway::GATEWAY_NAME);
        $this->connection->setName('oxid');
