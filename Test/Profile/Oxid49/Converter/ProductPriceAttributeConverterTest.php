...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49ProductPriceAttributeConverter;
...
class ProductPriceAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49ProductPriceAttributeConverter
     */
    private $converter;

    protected function setUp(): void
    {
        $this->converter = new Oxid49ProductPriceAttributeConverter(new DummyMappingService(), new DummyLoggingService());
    ...
    public function testConvertTextAttribute(): void
    {
        ...
        static::assertSame('migration_ConnectionName_product_price_attr6', $converted['customFields'][0]['name']);
