...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49NumberRangeConverter;
...
class NumberRangeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49NumberRangeConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid49NumberRangeConverter($mappingService, $loggingService, $numberRangeRepo);
