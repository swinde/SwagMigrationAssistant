...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49ProductReviewConverter;
...
class ProductReviewConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49ProductReviewConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid49ProductReviewConverter($this->mappingService, $this->loggingService);
