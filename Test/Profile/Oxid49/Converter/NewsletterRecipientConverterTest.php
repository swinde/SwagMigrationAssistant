...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49NewsletterRecipientConverter;
...
class NewsletterRecipientConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49NewsletterRecipientConverter
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->newsletterReceiverConverter = new Oxid49NewsletterRecipientConverter($this->mappingService, $this->loggingService);
