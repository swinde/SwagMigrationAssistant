...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49SalesChannelConverter;
...
class SalesChannelConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49SalesChannelConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid49SalesChannelConverter(
            $this->mappingService,
            $this->loggingService,
            $paymentMethodRepo,
            $shippingMethodRepo,
