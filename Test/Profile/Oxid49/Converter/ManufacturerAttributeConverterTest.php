...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49ManufacturerAttributeConverter;
...
class ManufacturerAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid49ManufacturerAttributeConverter
     */
    private $converter;

    protected function setUp(): void
    {
        $this->converter = new Oxid49ManufacturerAttributeConverter(new DummyMappingService(), new DummyLoggingService());
