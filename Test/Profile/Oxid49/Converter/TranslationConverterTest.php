...
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49CategoryConverter;
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49ProductConverter;
use SwagMigrationAssistant\Profile\Oxid49\Converter\Oxid49TranslationConverter;
...
{
    /**
     * @var Oxid49TranslationConverter
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->translationConverter = new Oxid49TranslationConverter($this->mappingService, $this->loggingService);
    ...
    public function testConvertProductTranslation(): void
    {
        ...
        $productConverter = new Oxid49ProductConverter($this->mappingService, $this->loggingService, new DummyMediaFileService());
    ...
    public function testConvertCategoryTranslation(): void
    {
        ...
        $categoryConverter = new Oxid49CategoryConverter($this->mappingService, $this->loggingService, $mediaFileService);
