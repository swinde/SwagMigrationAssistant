...
class OrderDeliveryStateReaderTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $gatewayMock->method('readTable')->willReturn([
            ...
            ['id' => '1', 'name' => 'in_process', 'description' => 'In process', 'group' => 'state', 'mail' => 1],
    ...
    public function testGetPremapping(): void
    {
        ...
        static::assertSame('Closed', $choices[1]->getDescription());
