...
namespace SwagMigrationAssistant\Test\Profile\Oxid\Gateway\Local;
...
use SwagMigrationAssistant\Profile\Oxid\Gateway\Local\Reader\ProductPriceAttributeReader;
use SwagMigrationAssistant\Profile\Shopware55\Shopware55Profile;
use SwagMigrationAssistant\Test\Mock\Gateway\Dummy\Local\DummyLocalGateway;

class ProductPriceAttributeReaderTest extends TestCase
{
    ...
    {
        static::assertTrue($this->productPriceAttributeReader->supports($this->migrationContext));
