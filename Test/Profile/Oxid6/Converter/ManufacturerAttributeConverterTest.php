...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6ManufacturerAttributeConverter;
...
class ManufacturerAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6ManufacturerAttributeConverter
     */
    private $converter;

    protected function setUp(): void
    {
        $this->converter = new Oxid6ManufacturerAttributeConverter(new DummyMappingService(), new DummyLoggingService());
