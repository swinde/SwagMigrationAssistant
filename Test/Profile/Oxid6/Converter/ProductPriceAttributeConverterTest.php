...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6ProductPriceAttributeConverter;
...
class ProductPriceAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6ProductPriceAttributeConverter
     */
    private $converter;

    protected function setUp(): void
    {
        $this->converter = new Oxid6ProductPriceAttributeConverter(new DummyMappingService(), new DummyLoggingService());
