...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6MediaFolderConverter;
...
class MediaFolderConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid6MediaFolderConverter(new DummyMappingService(), $this->loggingService);
