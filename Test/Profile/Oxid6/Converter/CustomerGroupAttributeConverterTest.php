...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6CustomerGroupAttributeConverter;
...
class CustomerGroupAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6CustomerGroupAttributeConverter
     */
    private $converter;

    protected function setUp(): void
    {
        $this->converter = new Oxid6CustomerGroupAttributeConverter(new DummyMappingService(), new DummyLoggingService());
