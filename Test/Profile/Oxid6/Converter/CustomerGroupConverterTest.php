...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6CustomerGroupConverter;
...
class CustomerGroupConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6CustomerGroupConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid6CustomerGroupConverter($mappingService, new DummyLoggingService());
