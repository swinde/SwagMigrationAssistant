...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6NewsletterRecipientConverter;
...
class NewsletterRecipientConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6NewsletterRecipientConverter
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->newsletterReceiverConverter = new Oxid6NewsletterRecipientConverter($this->mappingService, $this->loggingService);
