...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6ProductAttributeConverter;
...
class ProductAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6ProductAttributeConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid6ProductAttributeConverter($mappingService, $this->loggingService);
