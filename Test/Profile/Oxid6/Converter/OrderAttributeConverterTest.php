...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6OrderAttributeConverter;
...
class OrderAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6OrderAttributeConverter
     */
    private $converter;

    protected function setUp(): void
    {
        $this->converter = new Oxid6OrderAttributeConverter(new DummyMappingService(), new DummyLoggingService());
