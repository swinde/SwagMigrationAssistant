...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6MainVariantRelationConverter;
...
class MainVariantRelationConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6MainVariantRelationConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid6MainVariantRelationConverter($this->mappingService, $this->loggingService);
