...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6SalesChannelConverter;
...
class SalesChannelConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6SalesChannelConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid6SalesChannelConverter(
            $this->mappingService,
            $this->loggingService,
            $paymentMethodRepo,
            $shippingMethodRepo,
