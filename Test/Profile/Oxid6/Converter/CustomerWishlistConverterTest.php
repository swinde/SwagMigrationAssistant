...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6CustomerWishlistConverter;
...
class CustomerWishlistConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6CustomerWishlistConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid6CustomerWishlistConverter($this->mappingService, new DummyLoggingService());
