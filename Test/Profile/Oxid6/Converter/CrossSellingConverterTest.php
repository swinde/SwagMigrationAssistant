...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6CrossSellingConverter;
...
{
    /**
     * @var Oxid6CrossSellingConverter
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->crossSellingConverter = new Oxid6CrossSellingConverter($this->mappingService, $this->loggingService);
