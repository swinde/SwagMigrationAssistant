...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6CategoryAttributeConverter;
...
class CategoryAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6CategoryAttributeConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid6CategoryAttributeConverter($mappingService, $this->loggingService);
