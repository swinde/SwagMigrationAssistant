...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6MediaConverter;
...
class MediaConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->mediaConverter = new Oxid6MediaConverter($mappingService, new DummyLoggingService(), $mediaFileService);
