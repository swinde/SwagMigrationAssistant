...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6ProductReviewConverter;
...
class ProductReviewConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6ProductReviewConverter
     */
    private $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid6ProductReviewConverter($this->mappingService, $this->loggingService);
