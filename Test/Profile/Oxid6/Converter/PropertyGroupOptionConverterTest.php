...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6ProductOptionRelationConverter;
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6ProductPropertyRelationConverter;
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6PropertyGroupOptionConverter;
...
class PropertyGroupOptionConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6PropertyGroupOptionConverter
     */
    ...
    /**
     * @var Oxid6ProductConverter
     */
    private $productConverter;

    /**
     * @var Oxid6ProductOptionRelationConverter
     */
    private $optionRelationConverter;

    /**
     * @var Oxid6ProductPropertyRelationConverter
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->propertyGroupOptionConverter = new Oxid6PropertyGroupOptionConverter(
            $this->mappingService,
            $this->loggingService,
            $mediaFileService
        );

        $this->productConverter = new Oxid6ProductConverter(
            $this->mappingService,
            $this->loggingService,
            $mediaFileService
        );

        $this->optionRelationConverter = new Oxid6ProductOptionRelationConverter(
            $this->mappingService,
            $this->loggingService
        );

        $this->propertyRelationConverter = new Oxid6ProductPropertyRelationConverter(
            $this->mappingService,
            $this->loggingService
        );
