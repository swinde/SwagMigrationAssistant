...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6CustomerAttributeConverter;
...
class CustomerAttributeConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6CustomerAttributeConverter
     */
    private $converter;

    protected function setUp(): void
    {
        $this->converter = new Oxid6CustomerAttributeConverter(new DummyMappingService(), new DummyLoggingService());
