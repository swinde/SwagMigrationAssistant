...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6PromotionConverter;
...
class PromotionConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->converter = new Oxid6PromotionConverter($this->mappingService, $this->loggingService, $salesChannelRepo);
