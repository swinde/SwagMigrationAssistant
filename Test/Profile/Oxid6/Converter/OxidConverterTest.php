...
use SwagMigrationAssistant\Profile\Oxid6\Mapping\Oxid6MappingServiceInterface;
...
abstract class OxidConverterTest extends TestCase
{
    /**
    ...
    abstract protected function createConverter(Oxid6MappingServiceInterface $mappingService, LoggingServiceInterface $loggingService, MediaFileServiceInterface $mediaFileService): ConverterInterface;

    abstract protected function createProfile(): Oxid6MappingServiceInterface;
