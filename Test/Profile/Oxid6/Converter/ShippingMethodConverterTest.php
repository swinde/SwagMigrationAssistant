...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6ShippingMethodConverter;
...
class ShippingMethodConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->shippingMethodConverter = new Oxid6ShippingMethodConverter($this->mappingService, $this->loggingService);
