...
namespace SwagMigrationAssistant\Test\Profile\Oxid6\Converter;
...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6CategoryConverter;
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6ProductConverter;
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6TranslationConverter;
...
class TranslationConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->translationConverter = new Oxid6TranslationConverter($this->mappingService, $this->loggingService);
    ...
    public function testConvertProductTranslation(): void
    {
        ...
        $productConverter = new Oxid6ProductConverter($this->mappingService, $this->loggingService, new DummyMediaFileService());
    ...
    public function testConvertProductAttributeTranslation(): void
    {
        ...
        $expected = [
            'migration_Oxid6_product_checkboxTrue' => true,
            'migration_Oxid6_product_checkboxFalse' => false,
            'migration_Oxid6_product_int' => 100,
            'migration_Oxid6_product_float' => 55.23,
        ];
    ...
    public function testConvertCategoryTranslation(): void
    {
        ...
        $categoryConverter = new Oxid6CategoryConverter($this->mappingService, $this->loggingService, $mediaFileService);
        ...
        $expected = [
            ...
            'translations' => [
                DummyMappingService::DEFAULT_LANGUAGE_UUID => [
                    'customFields' => [
                        'migration_Oxid6_product_attr1' => 'My free textfield',
                    ],
