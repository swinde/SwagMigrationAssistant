...
use SwagMigrationAssistant\Profile\Oxid\Exception\ParentEntityForChildNotFoundException;
...
class CategoryConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->categoryConverter = new Oxid6CategoryConverter($mappingService, $this->loggingService, $mediaFileService);
