...
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6CustomerConverter;
use SwagMigrationAssistant\Profile\Oxid6\Converter\Oxid6OrderConverter;
...
class OrderConverterTest extends TestCase
{
    ...
    /**
     * @var Oxid6OrderConverter
     */
    private $orderConverter;

    /**
     * @var Oxid6CustomerConverter
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->orderConverter = new Oxid6OrderConverter($mappingService, $this->loggingService, $taxCalculator);
        $this->customerConverter = new Oxid6CustomerConverter($mappingService, $this->loggingService, Validation::createValidator());
